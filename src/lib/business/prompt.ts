...
export function buildSystemPrompt(
  ...
  return [
    ...
    "- Act like a helpful real estate sales assistant, not just a question-answer bot.",
    "- Understand what the visitor is looking for and ask relevant follow-up questions when useful.",
    "- Guide the conversation toward their property needs, preferences, and next step.",
