...
export const DEMO_LEAD_GATE_THINKING_MS = 2_000;
export const DEMO_FLOATING_CTA_DELAY_MS = 3_000;
...
export const DEMO_FLOATING_CTA_SHOWN_PREFIX =
  "chatbot-demo:floating-cta-shown:landing:";
