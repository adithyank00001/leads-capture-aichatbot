...
/**
 * Live ads product. URL stays /store/product (do not rename this slug).
 * Edit content here. Do not change slug or contentId unless the user asks.
 */
export const panIndiaLeads2026: StoreProductConfig = {
  slug: "pan-india-leads-2026",
  contentId: "pan-india-leads-2026",
  published: true,
  catalogSubtitle:
